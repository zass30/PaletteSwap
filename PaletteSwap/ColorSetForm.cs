...
namespace PaletteSwap
{
    public partial class ColorSetForm : Form
    {
        ...
        public void Reload()
        {
            ...
            {
                if (mainform.characterSet.characterColors[0].sprite != null)
                    CLAW_neutralStandBox00.Image = mainform.characterSet.characterColors[0].sprite.GetBitmap("neutral");
                if (mainform.characterSet.characterColors[1].sprite != null)
                    CLAW_neutralStandBox01.Image = mainform.characterSet.characterColors[1].sprite.GetBitmap("neutral");
                if (mainform.characterSet.characterColors[2].sprite != null)
                    CLAW_neutralStandBox02.Image = mainform.characterSet.characterColors[2].sprite.GetBitmap("neutral");
                if (mainform.characterSet.characterColors[3].sprite != null)
                    CLAW_neutralStandBox03.Image = mainform.characterSet.characterColors[3].sprite.GetBitmap("neutral");
                if (mainform.characterSet.characterColors[4].sprite != null)
                    CLAW_neutralStandBox04.Image = mainform.characterSet.characterColors[4].sprite.GetBitmap("neutral");
                if (mainform.characterSet.characterColors[5].sprite != null)
                    CLAW_neutralStandBox05.Image = mainform.characterSet.characterColors[5].sprite.GetBitmap("neutral");
                if (mainform.characterSet.characterColors[6].sprite != null)
                    CLAW_neutralStandBox06.Image = mainform.characterSet.characterColors[6].sprite.GetBitmap("neutral");
                if (mainform.characterSet.characterColors[7].sprite != null)
                    CLAW_neutralStandBox07.Image = mainform.characterSet.characterColors[7].sprite.GetBitmap("neutral");
                if (mainform.characterSet.characterColors[8].sprite != null)
                    CLAW_neutralStandBox08.Image = mainform.characterSet.characterColors[8].sprite.GetBitmap("neutral");
                if (mainform.characterSet.characterColors[9].sprite != null)
                    CLAW_neutralStandBox09.Image = mainform.characterSet.characterColors[9].sprite.GetBitmap("neutral");
            }
        }
    }
}
